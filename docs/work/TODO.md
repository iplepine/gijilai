...
- [ ] `GJ-009-coparent-invite-thin-slice`: 공동양육자 비대칭 초대(Option C) thin-slice 구현. 마이그레이션 018 + Co-parent API 5 + Owner/Invited UI + 작성자 라벨 + 상담 LLM 컨텍스트. GJ-008 검증의 코드 의존성을 닫는다. 정책: `docs/product/policies/co-parent.md`.
