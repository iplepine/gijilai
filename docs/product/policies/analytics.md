...
| `practice_log_saved` | 실천 기록 완료율과 첫 기록 여부 확인 | `done`, `first_log`, `has_full_access`, `with_reaction_feedback`, `quick_checkin`, `source`, `child_reaction_type`, `parent_impression_type` |
